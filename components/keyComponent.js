				...
				<div className="w-full flex text-white">
					<div className="ticket w-1/2 bg-mintGreen-400 flex">
						<div className="ticket-inner flex-1 flex flex-col justify-center items-center">
							<a
								href="#about"
								className="w-full h-full pt-10 md:pt-14 pb-10 flex flex-col items-center text-white hover:text-mintGreen-100 hover:no-underline transition-all"
							>
					...
					<div className="ticket w-1/2 bg-sand-400 flex">
						<div className="ticket-inner flex-1 flex flex-col justify-center items-center">
							<a
								href="#about"
								className="w-full h-full pt-10 md:pt-14 pb-10 flex flex-col items-center text-white hover:text-sand-100 hover:no-underline transition-all"
							>
								<h3 className="font-dinNarrow font-semibold text-2xl md:text-6xl mb-3">
									Career
								</h3>
